<header class="header-wrapper  d-none d-sm-block">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <a class="" href="{{route('index')}}"><img class="header-logo" src="{{asset('assets/vku/img/header_logo.png')}}"></a>
            </div>
            <div class="col-4">
...
<nav class="navbar navbar-expand-lg navbar-light bg-white py-3 shadow-sm sticky-top">
    ...
    <div id="navbarContent" class="collapse navbar-collapse">
        <ul class="navbar-nav mx-auto">
            <li class="nav-item dropdown megamenu"><a id="megamneu" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle font-weight-bold text-uppercase">Giới thiệu</a>
                ...
                <div aria-labelledby="megamneu" class="dropdown-menu border-0 p-0 m-0">
                    <div class="container">
                        <div class="row bg-white rounded-0 m-0 shadow-sm">
                            ...
                            <div class="col-lg-5 col-xl-4 px-0 d-none d-lg-block" style="background: center center url(http://vku.udn.vn/uploads/picture/Media61.JPG)no-repeat; background-size: cover;"></div>
                        </div>
                    </div>
                </div>
            </li>
            <li class="nav-item"><a href="" class="nav-link font-weight-bold text-uppercase">Liên hệ</a></li>
            <li class="nav-item"><a href="" class="nav-link font-weight-bold text-uppercase">Tài nguyên</a></li>
        </ul>
    </div>
</nav>
