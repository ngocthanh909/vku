            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input id="Name_vi" name="Name_vi" type="text" placeholder="Tên danh mục (tiếng Việt)" class="form-control input-md" required1="">
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input id="Name_en" name="Name_en" type="text" placeholder="Tên danh mục (tiếng Anh)" class="form-control input-md" required1="">
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
